...
export default function About() {
  return (
    <section id="about" className="section-bg relative mx-auto max-w-5xl overflow-hidden px-6 py-24">
      ...
      <StampText text="About" as="h2" className="relative z-10 mb-12 text-2xl" />
      ...
      <div className="relative z-10 grid gap-12 md:grid-cols-[1.2fr_1fr]">
        ...
        >
          <p className="font-body text-lg leading-relaxed text-text-primary">
            Developer with 4 years of production experience. I started in QA
            automation — breaking things professionally — and now I build the
            systems I used to test. I think in edge cases, write code that
            handles failure before it ships, and care about reliability as much
            as features.
          </p>
          <p className="mt-4 font-body text-base text-text-muted">
            Based in Buenos Aires. Currently focused on backend development
